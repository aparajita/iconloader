...
public class DoubleColor extends Color {
  ...
  public static final DoubleColor red = new DoubleColor(
    Color.red,
    new Color(255, 100, 100)
  );
  public static final DoubleColor RED = red;

  public static final DoubleColor blue = new DoubleColor(
    Color.blue,
    new Color(0x589df6)
  );
  public static final DoubleColor BLUE = blue;

  public static final DoubleColor white = new DoubleColor(
    Color.white,
  ...
  public static final DoubleColor lightGray = new DoubleColor(
    Gray._192,
    Gray._64
  );
  public static final DoubleColor LIGHT_GRAY = lightGray;

  public static final DoubleColor darkGray = new DoubleColor(
    Gray._64,
    Gray._192
  );
  public static final DoubleColor DARK_GRAY = darkGray;

  public static final DoubleColor pink = new DoubleColor(
    Color.pink,
    Color.pink
  );
  public static final DoubleColor PINK = pink;

  public static final DoubleColor orange = new DoubleColor(
    Color.orange,
    new Color(159, 107, 0)
  );
  public static final DoubleColor ORANGE = orange;

  public static final DoubleColor yellow = new DoubleColor(
    Color.yellow,
    new Color(138, 138, 0)
  );
  public static final DoubleColor YELLOW = yellow;

  public static final DoubleColor green = new DoubleColor(
    Color.green,
    new Color(98, 150, 85)
  );
  public static final DoubleColor GREEN = green;

  public static final Color magenta = new DoubleColor(
    Color.magenta,
    new Color(151, 118, 169)
  );
  public static final Color MAGENTA = magenta;

  public static final Color cyan = new DoubleColor(
    Color.cyan,
    new Color(0, 137, 137)
  );
