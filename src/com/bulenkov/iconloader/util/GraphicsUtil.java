...
public class GraphicsUtil {
  ...
  public static void setupAntialiasing(
    ...
    if (g2 instanceof Graphics2D g) {
      ...
      //noinspection HardCodedStringLiteral,unchecked
      var map = (Map<Object, Object>) tk.getDesktopProperty(
  ...
  public static GraphicsConfig setupAAPainting(Graphics g) {
    final var config = new GraphicsConfig(g);
  ...
  public static GraphicsConfig paintWithAlpha(Graphics g, float alpha) {
    assert 0.0f <= alpha &&
    alpha <= 1.0f : "alpha should be in range 0.0f .. 1.0f";
    final var config = new GraphicsConfig(g);
    final var g2 = (Graphics2D) g;
