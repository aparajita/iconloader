 ...
 * allows the logging to be lightweight and easy to capture (every imgscalr log
...
public class Scalr {
   ...
   * antialiasing filter (softens the image a bit) when applied to an image.
   * <p/>
  ...
  public enum Method {
     ...
     * for 80% of people looking to scale an image quickly and get a good-looking
     * result.
     */
    AUTOMATIC,
    /**
  ...
  public static BufferedImage apply(BufferedImage src, BufferedImageOp... ops)
    ...
    for (var bufferedImageOp : ops) {
      var subT = System.currentTimeMillis();
      ...
      var result = bufferedImageOp.filter(src, dest);
  ...
  public static BufferedImage pad(
     ...
     * image.
     */
    var sizeDiff = (padding * 2);
    var newWidth = srcWidth + sizeDiff;
    var newHeight = srcHeight + sizeDiff;
    ...
    var colorHasAlpha = (color.getAlpha() != 255);
    var imageHasAlpha = (src.getTransparency() != BufferedImage.OPAQUE);
  ...
  public static BufferedImage resize(
    ...
    var ratio = ((float) currentHeight / (float) currentWidth);
  ...
  protected static Method determineScalingMethod(
    ...
    var length = (ratio <= 1 ? targetWidth : targetHeight);
  ...
  protected static BufferedImage scaleImage(
    ...
    var result = createOptimalImage(src, targetWidth, targetHeight);
    var resultGraphics = result.createGraphics();
  ...
  protected static BufferedImage scaleImageIncrementally(
     ...
     * Windows 7).
     *
     * A divisor of 7 was chosen as using 5 still left some jaggedness in the
     ...
     */
    var fraction = (scalingMethod == Method.ULTRA_QUALITY ? 7 : 2);
    ...
    do {
      ...
      var incrementalImage = scaleImage(
        src,
        currentWidth,
        currentHeight,
        interpolationHintValue
